...
public class TestKotlinCounter {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, InterruptedException {

        String MainClass = "Counter";
        String MainPath = "src/main/java/org/example/concurrent/programs/kotlin/counter/";
        String packagePath = "org.example.concurrent.programs.kotlin.counter.";
        ByteCodeManager byteCodeManager = new ByteCodeManager(MainPath, MainClass);
        byteCodeManager.generateKotlinByteCode();
