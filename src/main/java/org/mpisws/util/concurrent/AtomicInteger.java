...
public class AtomicInteger {
  ...
  public AtomicInteger() {
    RuntimeEnvironment.writeOperation(
        this, 0, Thread.currentThread(), "org/mpisws/util/concurrent/AtomicInteger", "value", "I");
    value = 0;
    RuntimeEnvironment.waitRequest(Thread.currentThread());
  }
  ...
  public int get() {
    RuntimeEnvironment.readOperation(
        this, Thread.currentThread(), "org/mpisws/util/concurrent/AtomicInteger", "value", "I");
    int result = value;
    RuntimeEnvironment.waitRequest(Thread.currentThread());
    return result;
  }
