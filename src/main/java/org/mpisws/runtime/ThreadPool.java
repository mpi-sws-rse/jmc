...
/**
 * Encapsulates all the operations related to Thread objects used by the runtime
 * Except the SchedulerThread
 * The encapsulation ensures no memory leak when creating many threads
 */
