...
public class RuntimeEnvironment {
    ...
    public static int coverage = 1;

    public static Set<String> coveregeSet = new HashSet<>();

    public static List<String> coveregeList = new ArrayList<>();
     ...
     */
    public static Location createLocation(Object obj, String owner, String name, String descriptor) {
        try {
