...
/**
 * The Finished class is a serializable class that is used to signal the end of the model checking
 * process. The class contains a boolean flag to indicate whether the task should terminate and a
 * FinishedType to indicate the type of task that has finished.
 */
