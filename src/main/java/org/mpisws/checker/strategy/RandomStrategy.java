...
public class RandomStrategy implements SearchStrategy {
  ...
  private static final Logger LOGGER = LogManager.getLogger(RandomStrategy.class);
  ...
  public void nextSymAssumeRequest(Thread thread, SymbolicOperation symbolicOperation) {
    ...
    LOGGER.debug(
        "The result of the symbolic assume operation is " + RuntimeEnvironment.solverResult);
  ...
  public void nextSymbolicOperationRequest(Thread thread, SymbolicOperation symbolicOperation) {
    ...
    LOGGER.debug(
        "The result of the symbolic arithmetic operation is {}", RuntimeEnvironment.solverResult);
