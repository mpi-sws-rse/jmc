...
public abstract class OptDPORStrategy implements SearchStrategy {
  ...
  protected void updateGraphOps() {
    //        System.out.println("[OPT-DPOR Strategy Message] : The new graph operations generated
    // are :");
  ...
  public void nextStartEvent(Thread calleeThread, Thread callerThread) {
    if (guidingActivate) {
      ...
      // System.out.println("[OPT-DPOR Strategy Message] : The start event is passed to the model
      // checker");
  ...
  public void nextMainStartEvent(MainStartEvent mainStartEvent) {
    if (guidingActivate) {
      ...
      // System.out.println("[OPT-DPOR Strategy Message] : The main start event is passed to the
      // model checker");
  ...
  public void nextJoinEvent(Thread joinReq, Thread joinRes) {
    if (guidingActivate) {
      ...
      // System.out.println("[OPT-DPOR Strategy Message] : The join event is passed to the model
      // checker");
  ...
  public void nextFinishEvent(Thread thread) {
    if (guidingActivate) {
      ...
      // System.out.println("[OPT-DPOR Strategy Message] : The finish event is passed to the model
      // checker");
  ...
  public void nextFailureEvent(Thread thread) {
    if (guidingActivate) {
      ...
      // System.out.println("[OPT-DPOR Strategy Message] : The failure event is passed to the model
      // checker");
  ...
  public void nextDeadlockEvent(Thread thread) {
    if (guidingActivate) {
      ...
      // System.out.println("[OPT-DPOR Strategy Message] : The deadlock event is passed to the model
      // checker");
  ...
  public void nextConAssumeRequest(ConAssumeEvent conAssumeEvent) {
    if (guidingActivate) {
      ...
      // System.out.println("[OPT-DPOR Strategy Message] : The con assume event is passed to the
      // model checker");
  ...
  public void nextAssumeBlockedRequest(AssumeBlockedEvent assumeBlockedEvent) {
    if (guidingActivate) {
      ...
      // System.out.println("[OPT-DPOR Strategy Message] : The assume blocked event is passed to the
      // model checker");
      ...
      if (dpor.getExtendedGraph() == null || dpor.getTopoSort() == null) {
        ...
        if (RuntimeEnvironment.verbose) {
          ...
          for (int i = 0; i < RuntimeEnvironment.guidingEvents.size(); i++) {
            ...
            System.out.println(
                i + "-" + e.getType() + "(" + e.getTid() + ":" + e.getSerial() + ")");
          }
        }
        return false;
      }
