...
public class ArithmeticFormula {
   ...
   * the operation. Then, it creates a symbolic operation object and checks the type of the abstract
   * integers. If both abstract integers are symbolic integers, it creates an integer formula for
   * the left and right operands and creates a boolean formula for the equality operation. If one of
   * the abstract integers is a symbolic integer and the other is a concrete integer, it creates an
   * integer formula for the left operand and a number formula for the right operand and creates a
   * boolean formula for the equality operation. If both abstract integers are concrete integers, it
   * creates a number formula for the left and right operands and creates a boolean formula for the
   * equality operation. If the type of the abstract integers is not supported, it prints an error
   ...
   * integer value. It creates a concrete integer object with the integer value and calls the {@link
   * #eq(AbstractInteger, AbstractInteger)} method with the abstract integer and the concrete
   * integer.
   *
   ...
   *
   * <p>This method creates a symbolic equality operation based on an integer value and an abstract
   * integer by calling the {@link #eq(AbstractInteger, int)} method with the abstract integer and
   * the integer value.
   *
   ...
   * it clears the integer variable map which stores the symbolic integer variable which are used in
   * the operation. Then, it creates a symbolic operation object and checks the type of the abstract
   * integers. If both abstract integers are symbolic integers, it creates an integer formula for
   * the left and right operands and creates a boolean formula for the inequality operation. If one
   * of the abstract integers is a symbolic integer and the other is a concrete integer, it creates
   * an integer formula for the left operand and a number formula for the right operand and creates
   * a boolean formula for the inequality operation. If both abstract integers are concrete
   * integers, it creates a number formula for the left and right operands and creates a boolean
   * formula for the inequality operation. If the type of the abstract integers is not supported, it
   ...
   * integer value. It creates a concrete integer object with the integer value and calls the {@link
   * #neq(AbstractInteger, AbstractInteger)} method with the abstract integer and the concrete
   * integer.
   *
   * @param var1 the abstract integer.
   * @param var2 the integer value.
   ...
   * the operation. Then, it creates a symbolic operation object and checks the type of the abstract
   * integers. If both abstract integers are symbolic integers, it creates an integer formula for
   * the left and right operands and creates a boolean formula for the geq operation. If one of the
   * abstract integers is a symbolic integer and the other is a concrete integer, it creates an
   * integer formula for the left operand and a number formula for the right operand and creates a
   * boolean formula for the geq operation. If both abstract integers are concrete integers, it
   * creates a number formula for the left and right operands and creates a boolean formula for the
   * geq operation. If the type of the abstract integers is not supported, it prints an error
   * message and exits the program.
   *
   * @param var1 the first abstract integer.
   * @param var2 the second abstract integer.
   ...
   * integer by calling the {@link #geq(AbstractInteger, int)} method with the abstract integer and
   * the integer value.
   *
   * @param var1 the integer value.
   * @param var2 the abstract integer.
