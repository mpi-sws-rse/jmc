...
//        System.out.println(
//                "[Debugging] : Checking if the formula is dependent on the other formula");
...
//        for (Map.Entry<String, IntegerFormula> entry :
//                operation.getIntegerVariableMap().entrySet()) {
//            System.out.println("[Debugging] : " + entry.getKey() + " : " + entry.getValue());
//        }
//        for (Map.Entry<String, BooleanFormula> entry :
//                operation.getBooleanVariableMap().entrySet()) {
//            System.out.println("[Debugging] : " + entry.getKey() + " : " + entry.getValue());
//        }
//
//        for (Map.Entry<String, IntegerFormula> entry : this.getIntegerVariableMap().entrySet()) {
...
//    }
//
//    public void setJmcFormula(
//            SymbolicOperand left, SymbolicOperand right, InstructionType operator) {
