...
/**
 * This is simple concurrent counter program that demonstrates a deadlock between two threads over using two shared locks.
 */
...
public class BuggyCounter extends Thread {
    ...
    public BuggyCounter(Counter counter1, Counter counter2, ReentrantLock lock1, ReentrantLock lock2) {
    ...
    public void run() {
        try {
            ...
            System.out.println("[" + Thread.currentThread().getName() + " message] : The thread is interrupted");
        }
    }
