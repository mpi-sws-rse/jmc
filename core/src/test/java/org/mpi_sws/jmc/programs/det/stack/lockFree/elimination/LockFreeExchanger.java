package org.mpi_sws.jmc.programs.det.stack.lockFree.elimination;

import org.mpi_sws.jmc.api.util.concurrent.JmcAtomicStampedReference;
...
public class LockFreeExchanger<V> {
    ...
    JmcAtomicStampedReference<V> slot = new JmcAtomicStampedReference<V>(null, EMPTY);
