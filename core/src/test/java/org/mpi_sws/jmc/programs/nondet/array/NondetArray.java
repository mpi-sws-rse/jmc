package org.mpi_sws.jmc.programs.nondet.array;
//
...
//            }
//
//            // assert (sum == SIZE - 1) : " ***The assert did not pass, the sum is " + sum + "
//            // instead of
//            // " + (SIZE - 1);
//            // assert (sum <= SIZE) : " ***The assert did not pass, the sum is " + sum + " instead
//            // of " +
//            // SIZE;
//
